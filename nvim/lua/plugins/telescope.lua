		...
		pickers = {
			live_grep = {
				file_ignore_patterns = {
                    ...
                    ".*tags$",
                    ".*/auto_gen/",
                    ".*fw_output/.*", -- Ignore any fw_output subdirectory anywhere
                    "%.git/.*",
                    ".*/embarc_osp%-master/.*",  -- Ignore any embarc_osp-master subdirectory anywhere
                    ".*/2%.52a_.*/.*",
                    ".*/elfdump_.*/.*"
                },
			...
			find_files = {
				file_ignore_patterns = {
                    ...
                    "%.s",
                    "%.pyc",
                    ".*/tags$",        -- Ignore any file named tags anywhere
                    ".*/auto_gen/.*",  -- Ignore any auto_gen subdirectory anywhere
                    ".*/fw_output/.*", -- Ignore any fw_output subdirectory anywhere
                    "%.git/.*",
                    ".*/embarc_osp%-master/.*",  -- Ignore any embarc_osp-master subdirectory anywhere
                    ".*/2%.52a_.*/.*",
